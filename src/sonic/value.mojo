...
struct JsonValue(JsonContainerTrait, Stringable):
    ...
    fn __init__(out self):
        self._value = _sonic_ptr()[].jvalue_new()

    @always_inline
    fn __init__(out self, b: Bool):
        self._value = _sonic_ptr()[].jvalue_new_bool(b)

    @always_inline
    fn __init__(out self, i64: Int):
        self._value = _sonic_ptr()[].jvalue_new_i64(i64)
    ...
    fn __init__(out self, u64: UInt64):
        self._value = _sonic_ptr()[].jvalue_new_u64(u64)

    @always_inline
    fn __init__(out self, f64: Float64):
        self._value = _sonic_ptr()[].jvalue_new_f64(f64)
    ...
    fn __init__[T: Stringable](out self, s: T):
        ...
        self._value = _sonic_ptr()[].jvalue_new_str(s_view)

    @always_inline
    fn __copyinit__(out self, other: JsonValue):
        self._value = _sonic_ptr()[].jvalue_clone(other._value)
    ...
    fn from_str[T: Stringable](s: T) -> JsonValue:
        ...
        return JsonValue(_sonic_ptr()[].jvalue_from_str(s_view))

    @always_inline
    fn __del__(owned self):
        _sonic_ptr()[].jvalue_destroy(self._value)
    ...
    @always_inline
    fn get_type(self) -> JsonType:
        return _sonic_ptr()[].jvalue_get_type(self._value)
    ...
    fn is_true(self) -> Bool:
        return _sonic_ptr()[].jvalue_is_true(self._value)
    ...
    @always_inline
    fn is_i64(self) -> Bool:
        return _sonic_ptr()[].jvalue_is_i64(self._value)

    @always_inline
    fn is_u64(self) -> Bool:
        return _sonic_ptr()[].jvalue_is_u64(self._value)

    @always_inline
    fn is_f64(self) -> Bool:
        return _sonic_ptr()[].jvalue_is_f64(self._value)

    @always_inline
    fn is_str(self) -> Bool:
        return _sonic_ptr()[].jvalue_is_str(self._value)

    @always_inline
    fn is_object(self) -> Bool:
        return _sonic_ptr()[].jvalue_is_object(self._value)

    @always_inline
    fn is_array(self) -> Bool:
        return _sonic_ptr()[].jvalue_is_array(self._value)

    @always_inline
    fn as_bool(self, default: Bool = False) -> Bool:
        var ret = _sonic_ptr()[].jvalue_as_bool(self._value)
        if ret.is_ok:
            return ret.ok
        return default
    ...
    fn as_i64(self, default: Int64 = 0) -> Int64:
        var ret = _sonic_ptr()[].jvalue_as_i64(self._value)
        if ret.is_ok:
            return ret.ok
        return default
    ...
    fn as_u64(self, default: UInt64 = 0) -> UInt64:
        var ret = _sonic_ptr()[].jvalue_as_u64(self._value)
        if ret.is_ok:
            return ret.ok
        return default
    ...
    fn as_f64(self, default: Float64 = 0.0) -> Float64:
        var ret = _sonic_ptr()[].jvalue_as_f64(self._value)
        if ret.is_ok:
            return ret.ok
        return default
    ...
    fn as_str[T: Stringable](self, default: T) -> String:
        ...
        sonic[].jvalue_as_str(self._value, default_sref, out)
    ...
    fn to_string(self, cap: Int = 1024) -> String:
        ...
        _ = sonic[].jvalue_to_string(self._value, out)
        var s_data = sonic[].diplomat_buffer_write_get_bytes(out)
        var s_len = sonic[].diplomat_buffer_write_len(out)
...
struct ValueIter:
    ...
    fn __del__(owned self):
        _sonic_ptr()[].jvalueiter_destroy(self._iter)

    fn len(self) -> Int:
        return _sonic_ptr()[].jvalueiter_len(self._iter)

    fn next(self) -> JsonValueRef:
        return JsonValueRef(_sonic_ptr()[].jvalueiter_next(self._iter))
...
struct ValueIterMut:
    ...
    fn __del__(owned self):
        _sonic_ptr()[].jvalueitermut_destroy(self._iter)

    fn len(self) -> Int:
        return _sonic_ptr()[].jvalueitermut_len(self._iter)

    fn next(self) -> JsonValueMut:
        return JsonValueMut(_sonic_ptr()[].jvalueitermut_next(self._iter))
